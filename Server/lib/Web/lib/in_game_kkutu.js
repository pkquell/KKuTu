...
function chat(profile, msg, from, timestamp){
	...
	if(msg.indexOf("kkutu.co.kr") != -1
	|| msg.indexOf("cafe.naver.com/kkutu") != -1
	|| msg.indexOf("goo.gl/uPSWlf") != -1
	|| msg.indexOf("goo.gl/Vmd3TF") != -1
	|| msg.indexOf("discord.gg/a8UqyrY") != -1
	|| msg.indexOf("끄투.co.kr") != -1
	|| msg.indexOf("modookktu") != -1){
		return;
		//방마다 찾아가면서 홍보하고 다니시는데 매너있게좀 운영합니다 ^^;
	}
	if(from){
